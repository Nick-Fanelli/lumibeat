...
struct State {
    app_instances: Mutex<HashMap<String, tauri::WebviewWindow>>,
...
fn get_app_window_info(
    ...
    match lookup_window {
        Some(value) => {
            ...
            let json_string = serde_json::to_string(&window_info)
        ...
        None => Err(String::from("Could not lookup")),
    }
}
